...
https://linear.app/secondbrainclaw/issue/PRO-90/12-sistema-de-streaks-and-xp-com-niveis /feature-marker --interactive -prd-sistema-breaks-niveis
...
1. Primary Request and Intent:
   - **Social Feed Bug Fixes (PRO-89)**: User reported three issues with the social feed feature: (a) feed tab not appearing despite Remote Config being `true`, (b) pull-to-refresh causing infinite loading loop (primary concern with emphasis on Swift concurrency rules), (c) empty state not showing when no ...
