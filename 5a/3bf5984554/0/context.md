...
Mude essa descrição pois não está mais fazendo essa das perguntas iniciais, o foco agora é acompanhamento dos treinos, os programas gerados, os desafios entre amigos e as sugestões de treinos com o chat na IA onde essa é uma feature paga. Refaça o app-marketing-context.md

### Prompt 21

Documentação exigida pela apple para criptografia, Especifique seu uso de criptografia no Xcode adicionando a chave O aplicativo usa criptografia não isenta no arquivo Info.plist do seu app com um valor booleano que indica se seu app usa criptografia.

### Prompt 22

Preciso que o build de todos os testes unitarios esteja funcionando para subir o aplicativo para a loja.
...
Summary:
1. Primary Request and Intent:
   - **Fix all unit test build errors** so the app can be submitted to the App Store (`"Preciso que o build de todos os testes unitarios esteja funcionando para subir o aplicativo para a loja"`)
   - Previous completed requests in this session:
     - Write unit tests for Task 8 / issue #82 (ProgramRecomme...
