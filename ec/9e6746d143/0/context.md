...
Verifique todas as issues e faça as correções necessárias, sempre utilizando /swiftui-expert-skill para construir as views e manter o padrão, https://github.com/Viniciuscarvalho/FitToday/issues
...
- Previous sessions completed: Foundation + Onboarding, Home Redesign, Programs Tab, Workout Detail, AI FitP...

### Prompt 36

@/Users/viniciuscarvalho/Desktop/Captura de Tela 2026-02-25 às 21.06.01.png sobre a issue #22 , não deve ter nada de features de nutritions, aquilo foi apenas como referência, deve ser um card das estatíticas do usuário do dia um breve resumo e com uma imagem, e logo abaixo deve apresentar o workout do dia como está na imagem de referência.  Não deve ter nada de nutrition, até porque não é o foco da aplicação no momento. é só uma base para se guiar.

### Prompt 37

O card continua não sendo exibido na Home, está mostrando o treino gerado por IA, isso deve ser removido da Home, não irá mais ter, somente na aba de FitPal.
- Além disso as strings continuam chamando referências a FitPal, tudo que estiver na aplicação e estiver relacionado a esse nome deve ser trocado para FitOrb, que é a feature de IA da aplicação, isso deve ser corrigido também e testado.
- Ao tentar criar uma nova rotina na aba de programas também não está fazendo nada, deve r...
...
- Previous sessions implemented a major app reorganization for FitToday iOS app
- Completed: Foundation + Onboarding, Home Redesign, Programs Tab, Workout Detail, AI FitPal, Profile, Localization, Build verification
- PR #21 crea...

### Prompt 39

@/Users/viniciuscarvalho/Desktop/Captura de Tela 2026-02-25 às 21.06.01.png Na home não está aparecendo como o esperado na imagem, lembrando que esses dados de nutrition são ilustrativos, devem ser substituídos por dados do usuário, como os treinos na semana, calorias e a sequencia de treinos, hoje ele possui isso apenas em um card, mas deve ser igual ao que está na imagem. Além disso embaixo, deve apresentar o workout do dia, baseado nas específicações do usuário, como havia mencio...
...
- Previous sessions implemented a major app reorganization for FitToday iOS app
- PR #21 on branch `feature/reorganize-screens-and-flows`
- Issues #22-#25 were being addressed
- Task 1 (Remove AI workout generator from Home) was ...
