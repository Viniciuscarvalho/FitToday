...
## Discoveries
- Interesting connection between [[pattern A]] and [[pattern B]] found during /extract
- Domain guide [[concurrency]] might need splitting (40+ patterns observed during /connect)
```
